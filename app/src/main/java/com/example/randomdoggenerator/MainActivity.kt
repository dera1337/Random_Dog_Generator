package com.example.randomdoggenerator
...
import com.example.randomdoggenerator.api.ApiRequest
import com.example.randomdoggenerator.api.BASE_URL
    ...
    private fun makeApiRequest() {
        ...
        GlobalScope.launch(Dispatchers.IO) {
            try {
                ...
                if (response.fileSizeBytes < 600_000) {
